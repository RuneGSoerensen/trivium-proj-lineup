...
01. Link(s) til den deployede løsning (backend og
    frontend)
    - Frontend: `https://trivium.lol` (Omdirigerer
      til:
      `https://trivium-proj-lineup.vercel.app/`)
    - Backend: `https://trivium.lol/api`
02. Login-informationer til testbrugere (hvis
    relevant)
    - Morten Pedersen:
      - Email:
      - Password:
03. En kort teknisk beskrivelse af jeres
    arkitektur og valg af teknologier/frameworks
04. En liste og kort beskrivelse af de features, I
    har implementeret, med angivelse af den
    primære ansvarlige udvikler for hver feature,
    hvor det er relevant
05. Eventuelle kendte issues eller manglende
    features
06. En liste og kort beskrivelse af eventuelle
    ekstra features eller innovationer, I har
    tilføjet ud over kravene
07. En liste og kort beskrivelse af de områder,
...
08. Et fungerende link til jeres primære project
    board (eller et screenshot, hvis ikke det er
    offentligt tilgængeligt)
09. Fungerende links til:
