      ...
      {!showSocialEdit ? (
        ...
        <div className="space-y-3 mt-3">
          <input
            ...
            className="w-full px-4 py-3 rounded-xl bg-muted border-none text-[15px] text-default placeholder:color-muted/60 focus:outline-none focus:ring-2 focus:ring-brand-primary"
          />
          <input
            type="text"
            ...
            className="w-full px-4 py-3 rounded-xlmuted border-none text-[15px] text-default placeholder:color-muted/60 focus:outline-none focus:ring-2 focus:ring-brand-primary"
          />
          <input
            type="text"
